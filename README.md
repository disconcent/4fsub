...
<p align="center"><a href="https://heroku.com/deploy?template=https://github.com/supermanbot12/File-Sharing-4Button">
...
#### Deploy in your VPS
````bash
git clone https://github.com/supermanbot12/File-Sharing-4Button
cd File-Sharing-4Button
