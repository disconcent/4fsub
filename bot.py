    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL1:
            try:
                ...
                self.LOGGER(__name__).info(
                    "\nBot Berhenti. Tanya ke https://t.me/gkushskap untuk Bantuan"
                )
                sys.exit()
        ...
        if FORCE_SUB_GROUP:
            try:
                ...
                self.LOGGER(__name__).info(
                    "\nBot Berhenti. Gabung Group https://t.me/UnrealPiggy untuk Bantuan"
                )
                sys.exit()
        try:
            ...
            self.LOGGER(__name__).info(
                "\nBot Berhenti. Gabung Group https://t.me/exotisidbos untuk Bantuan"
            )
            sys.exit()

        self.set_parse_mode("html")
        self.LOGGER(__name__).info(
            f"[🔥 BERHASIL DIAKTIFKAN! 🔥]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan ke https://t.me/gkushskap"
        )
